...
class PriceController {
    ...
    def save(Price priceInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'priceInstance.label', default: 'Price'), priceInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'priceInstance.label', default: 'Price'), params.id])
                redirect action: "index", method: "GET"
            }
